  ...
  return (
    <>
      ...
      >
        ...
        {!!data.hasChildren && (
          <>
            <div className="absolute top-1/2 -translate-y-1/2 z-0" style={{ right: '-12px', width: '12px', height: '3px', backgroundColor: branchColor }} />
            <button 
              ...
              style={{ right: '-28px', borderColor: branchColor }}
            ...
            <div className="absolute top-1/2 -translate-y-1/2 z-0" style={{ right: '-40px', width: '12px', height: '3px', backgroundColor: branchColor }} />
          </>
        )}
        ...
        <Handle 
          ...
          className="opacity-0" 
          style={{ right: data.hasChildren ? '-40px' : '0px' }} 
          isConnectable={false} 
        />
